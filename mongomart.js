...
MongoClient.connect('mongodb://localhost:27017/mongomart', function(err, db) {
    ...
    router.get("/", function(req, res) {
        "use strict";
        console.log("######### Entered the Root Route in Mongomart.js #########");
        ...
        console.log("This function has been executed after the callback function returned a value and the category chosen is " + categories);
